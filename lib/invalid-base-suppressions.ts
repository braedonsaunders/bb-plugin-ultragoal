...
export function createInvalidBaseSuppressionStore(
  ...
  return {
    ...
    get(rootThreadId: string, itemId: string, repository: string, requestedRef: string) {
...
export type InvalidBaseSuppressionStore = ReturnType<typeof createInvalidBaseSuppressionStore>;
